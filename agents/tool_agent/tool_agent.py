...
class ReactAgent:
    ...
    def load_city(self, city_set_path: str) -> List[str]:
        ...
        # Print the absolute path of the city file
        abs_path = os.path.abspath(city_set_path)
        print("DEBUG: Attempting to open city file at:", abs_path)
...
if __name__ == '__main__':
    ...
    plan, scratchpad, action_log = generate_one_plan(user_query)
    print(plan)
    ...
    # #
    # # parser.add_argument("--set_type", type=str, default=os.getenv("SET_TYPE", "validation"))
    # # parser.add_argument("--model_name", type=str, default=os.getenv("MODEL_NAME", "gpt-3.5-turbo-1106"))
    # # parser.add_argument("--output_dir", type=str, default=os.getenv("OUTPUT_DIR", "../planner_agent/tools/planner/"))
